  ...
  const steps = [
    {
      ...
      description: 'Просто укажите полный адрес — этого достаточно, чтобы запустить проверку. Без сканов, доверенностей и регистрации на госпорталах.',
    },
    {
      number: '2. Сбор данных',
      title: 'Тянем данные из реестров и своих баз',
      description: 'Автоматически сверяем объект с реестрами, судебными делами, открытыми источниками и собственными базами Домвизора по проблемным объектам и собственникам.',
    },
    {
      number: '3. Анализ рисков',
      title: 'Складываем полную картину',
    ...
    },
    {
      ...
      title: 'Даем подробный и понятный вердикт ',
      description: 'Вы получаете отчёт с оценкой риска и конкретными выводами: «идём спокойно», «только с юристом» или «не связываться».',
    },
  ];
      ...
      <div className="how-it-works-container">
        ...
        <div className="how-it-works-header">
          ...
          <p className="how-it-works-subtitle">
            От адреса до полного и подробного отчета — от 10–15 минут, без ручного копания в реестрах и судах.
          </p>
        </div>
