  ...
  const steps = [
    {
      ...
      description: 'Введите адрес или кадастровый номер — этого достаточно для запуска проверки. Без сканов документов, доверенностей и учётных записей.',
    },
    {
      number: '2. Сбор данных',
      title: 'Запрашиваем данные из реестров',
      description: 'Система автоматически запрашивает сведения из государственных реестров, судебных баз и внутренней базы Домвизора по проблемным объектам.',
    },
    {
      number: '3. Анализ рисков',
      title: 'Формируем полную картину',
      description: 'Проверяем историю перехода прав, обременения, ограничения, судебные споры и связи собственников. Выявляем типовые риск-схемы.',
    },
    {
      number: '4. Формируем отчёт',
      title: 'Выдаём подробный отчёт с вердиктом',
      description: 'Формируем отчёт с оценкой рисков и рекомендациями: «сделка безопасна», «нужна консультация юриста» или «высокий риск».',
    },
  ];
      ...
      <div className="how-it-works-container">
        ...
        <div className="how-it-works-header">
          <h2 className="how-it-works-title">
            Как мы в Домвизоре проверяем объекты
          </h2>
          <p className="how-it-works-subtitle">
            От ввода адреса до готового отчёта — 10–15 минут. Без регистрации на госпорталах и ручного сбора данных.
          </p>
        </div>
